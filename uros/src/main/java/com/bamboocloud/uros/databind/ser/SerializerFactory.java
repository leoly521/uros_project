...
public final class SerializerFactory {
	...
	private static final ConcurrentHashMap<Class<?>, UrosSerializer> serializers = new ConcurrentHashMap<Class<?>, UrosSerializer>();
	...
	@SuppressWarnings("rawtypes")
	public final static UrosSerializer get(Class<?> type) {
		UrosSerializer serializer = serializers.get(type);
		if (serializer == null) {
			if (type.isEnum()) {
